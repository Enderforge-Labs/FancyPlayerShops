...
public class MainMenu_InfoButton extends Hud_SimpleButton {
    ...
    public MainMenu_InfoButton(final @NotNull HudContext _hud) {
        super((ServerLevel)_hud.getPlayer().level(), null, "Info", 1, new Hud_SquareButton_S());
