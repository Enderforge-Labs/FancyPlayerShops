...
public class _MainMenu_ManageShopsButton extends FancyButtonElm {
    public _MainMenu_ManageShopsButton(final @NotNull HudContext context) {
        super(context.getLevel(), null, "Manage your shops", 1, new _MainMenu_LargeButton_S("Manage shops"));
