 ...
 */
public class Any_InputIndicator_MouseButtonUp_S extends ShopPanelElm_S {
     ...
     */
    public Any_InputIndicator_MouseButtonUp_S() {
        super();
    }
    ...
    public @NotNull Transform getDefaultTransform() {
        return super.getDefaultTransform()
            .scale(BUTTON_SCALE)
            .moveX(-(Any_DualInputIndicator.DEFAULT_DUAL_INDICATOR_SIZE.x * Any_InputIndicator.MOUSE_SIZE.x * Any_InputIndicator.BUTTON_SIZE.x * (BUTTON_SCALE - 1)) / 2)
        ;
    }
}
