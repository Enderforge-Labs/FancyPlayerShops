 ...
 */
public class Edit_PriceInput extends ShopTextInput {
    ...
    public Edit_PriceInput(final @NotNull Shop _shop) {
        super(_shop, null, "Change price", new Txt("Send the new price in chat!").color(ShopManager.SHOP_ITEM_NAME_COLOR).bold().get(), new Edit_Input_S(_shop));
        updateDisplay(null);
    }
