...
public class TransferUi_Input_S extends ShopTextInput_S {
    ...
    public @Nullable Animation getDefaultHoverPrimerAnimation() {
        return new Animation(
            new Transition()
            .additiveTransformBg(new Transform().scaleX(SimpleButtonElmStyle.HIDDEN_W).moveX(0.5f))
        );
    }
    @Override
    public @Nullable Animation getDefaultHoverEnterAnimation () {
        return new Animation(
            ...
            .additiveTransformBg(new Transform().scaleX(1f / SimpleButtonElmStyle.HIDDEN_W).moveX(-0.5f))
        );
    }
    @Override
