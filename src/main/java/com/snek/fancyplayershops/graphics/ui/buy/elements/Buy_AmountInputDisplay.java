...
public class Buy_AmountInputDisplay extends ShopTextInput {
    private final @NotNull BuyCanvas menu;


    public Buy_AmountInputDisplay(final @NotNull Shop _shop, final @NotNull BuyCanvas _menu) {
        super(_shop, null, "Specify buy amount", new Txt("Send the amount in chat!").color(ShopManager.SHOP_ITEM_NAME_COLOR).get(), new Buy_Input_S(_shop));
        menu = _menu;
        updateDisplay(null);
    }
