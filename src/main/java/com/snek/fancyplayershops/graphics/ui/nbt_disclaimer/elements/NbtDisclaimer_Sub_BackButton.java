package com.snek.fancyplayershops.graphics.ui.nbt_disclaimer.elements;
...
public class NbtDisclaimer_Sub_BackButton extends SimpleButtonElm {
    public NbtDisclaimer_Sub_BackButton(final @NotNull ProductDisplay display) {
    ...
    public void onClick(final @NotNull Player player, final @NotNull ClickAction click, final @NotNull Vector2f coords) {
        ...
        display.changeCanvas(new BuyCanvas(display));
    }
}
