package com.snek.fancyplayershops.shop_ui.buy;
...
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUiSub_BackButton;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_1iButton;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_1sButton;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_1xButton;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_AmountInputDisplay;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_ConfirmButton;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_ItemInspector;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_PriceDisplay;
import com.snek.fancyplayershops.shop_ui.buy.elements.BuyUi_Title;
...
public class BuyUi extends ShopCanvas implements InputIndicatorCanvas {
    ...
    public BuyUi(final @NotNull Shop _shop) {
        ...
        super(_shop, 1, ShopFancyTextElm.LINE_H, UiBorder.DEFAULT_HEIGHT);
        shop = _shop;
        Div e;
        ...
        e.setPosY(UiBorder.DEFAULT_HEIGHT * 2);
        e.setAlignmentX(AlignmentX.CENTER);
